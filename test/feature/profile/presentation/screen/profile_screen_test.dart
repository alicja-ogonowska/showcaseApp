...
void main() {
  ...
  group('Profile screen', () {
    group('For logged in user', () {
      testWidgets('should display user name greeting and logout button',
          (tester) async {
    ...
    group('For not logged in user', () {
      testWidgets(
          'should display login form and login user with correct credentials using login button',
          (tester) async {
        ...
        await enterText(tester, findFormFieldByHint('E-mail'), correctEmail);
        await enterText(
          tester,
      ...
      testWidgets(
        ...
        await enterText(tester, findFormFieldByHint('E-mail'), incorrectEmail);
        await enterText(
          tester,
          findFormFieldByHint('Password'),
          tooShortPassword,
      ...
      testWidgets(
        ...
        findFormFieldByHintAndIsObscured('Password', isObscured: true).once();

        await tap(tester, findTextWidget('SHOW'));
        findFormFieldByHintAndIsObscured('Password', isObscured: true).never();
